...
def intialize_server_request_info():
    """
        ...
        input_param : Request Data received by the server
        input_type : string
        
        out_param : Returns the request details in a dictionary
        out_type : Dict
...
def intialize_server_response_info(response_data=None):
    """
        ...
        input_param : data - Contains the response string to be sent
                    by server
        input_type : string
...
def verify_headers(request_hdrs_list, req_info, result_reason):
    """
        ...
        input_param : request_hdrs_list - Request header(HttpRequestHeaders) Table objects list
        input_type : list
