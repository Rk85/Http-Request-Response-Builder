...
class HttpRequestMethods(Base):
	"""Class for the Supported Http Methods 
...
class HttpRequestHeaders(Base):
	"""Static Http Request Header Class
...
class HttpData(Base):
	"""Http Data for the Http Request/Response
...
class HttpRequest(Base):
	"""Http Request class specifis the 
...
class HttpSubRequest(Base):
	"""Contains details about each of the Http requests
